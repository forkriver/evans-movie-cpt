...
class Evans_Movie {
	 ...
	 * @return array
	 */
	function metaboxes( $meta_boxes = array() ) {
		...
		$meta_boxes[] = array(
			'id'         => 'movie_metabox',
			'title'      => 'Movie Details',
			'pages'      => array( 'evans_movie', ), // Post type
			'context'    => 'normal',
			'priority'   => 'high',
			...
			'fields'     => array(
				array(
					'name' => 'Showtimes',
					'desc' => 'Showtimes description -- what can I say?',
					'type' => 'title',
					'id'   => $prefix . 'showtime_title',
				),
				array(
					'name' => '1st show',
					'id'   => $prefix . 'showtime1',
	...
	function check_for_cmb() {
		$class = "update-nag";
		$message = "Please install and/or activate the Custom Meta Box plugin for full functionality.";
